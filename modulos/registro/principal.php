...
$objeto         = new Registro();/*creacion del objeto*/
...
$imprimirXls = HTML::contenedor(HTML::botonAjax('documentoNuevo', $textos->id('IMPRIMIR_XLS'), HTML::urlInterna($modulo->nombre, 0, true, 'printXls')), 'alineadoDerecha margenSuperiorDoble', 'botonImprimirXlsRegistro');


$destinoCer             = '/ajax'.$objeto->urlBase.'/printCertificates';
$botonCertificar        = HTML::boton('chequeo', $textos->id('IMPRIMIR_CERTIFICADOS'), 'botonOk directo', 'botonOk', 'botonOk');
$imprimirCertificados   = HTML::contenedor(HTML::forma($destinoCer, $botonCertificar, 'P'), 'alineadoDerecha margenSuperiorDoble');

$destinoCar             = '/ajax'.$objeto->urlBase.'/printCarnets';
$botonCarnetizar        = HTML::boton('chequeo', $textos->id('IMPRIMIR_CARNETS'), 'botonOk directo', 'botonOk', 'botonOk');
$imprimirCarnets        = HTML::contenedor(HTML::forma($destinoCar, $botonCarnetizar, 'P'), 'alineadoDerecha margenSuperiorDoble');
...
$botonesSuperiores = HTML::contenedor($buscador.$imprimirCarnets.$imprimirCertificados.$imprimirXls.$botonAdicionar.$contenedorNotificaciones, '', 'botonesSuperioresModulo');
