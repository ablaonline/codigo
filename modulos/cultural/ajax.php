...
function adicionarCentro($datos = array()) {
    ...
    if (empty($datos)) {
        ...
        $respuesta["titulo"]  = $textos->id("ADICIONAR_CENTRO");
        ...
        if (empty($datos["nombre"])) {
        ...
        } elseif (!$sql->existeItem("lista_ciudades", "cadena", $datos["ciudad"])) {
            ...
            $datos["ciudad"] = $sql->obtenerValor("lista_ciudades", "id", "cadena = '".$datos["ciudad"]."'");
...
function modificarCentro($id, $datos = array()) {
    ...
    if (empty($datos)) {
        ...
        $respuesta["codigo"]  = $codigo;
        $respuesta["destino"] = "#cuadroDialogo";
        $respuesta["titulo"]  = $textos->id("MODIFICAR_CENTRO");
        $respuesta["ancho"]   = 700;
        $respuesta["alto"]    = 500;
...
function eliminarCentro($id, $confirmado) {
    ...
    if (!$confirmado) {
        ...
        $respuesta["codigo"]  = $codigo;
        $respuesta["destino"] = "#cuadroDialogo";
        $respuesta["titulo"]  = $textos->id("ELIMINAR_CENTRO");
        $respuesta["ancho"]   = 200;
        $respuesta["alto"]    = 120;
    } else {
...
function adicionarSede($datos = array()) {
    global $textos, $sql, $configuracion, $forma_centro;
    ...
    if (empty($datos)) {
        ...
        $respuesta["generar"] = true;
        $respuesta["codigo"]  = $codigo;
        $respuesta["titulo"]  = $textos->id("ADICIONAR_SEDE");
        $respuesta["destino"] = "#cuadroDialogo";
        $respuesta["ancho"]   = 480;
        $respuesta["alto"]    = 500;
...
function modificarSede($id, $datos = array()) {
    ...
    if (empty($datos)) {
        ...
        $respuesta["codigo"]  = $codigo;
        $respuesta["destino"] = "#cuadroDialogo";
        $respuesta["titulo"]  = $textos->id("MODIFICAR_SEDE");
        $respuesta["ancho"]   = 480;
        $respuesta["alto"]    = 500;
...
function eliminarSede($id, $confirmado) {
    ...
    if (!$confirmado) {
        ...
        $respuesta["codigo"]  = $codigo;
        $respuesta["destino"] = "#cuadroDialogo";
        $respuesta["titulo"]  = $textos->id("ELIMINAR_SEDE");
        $respuesta["ancho"]   = 200;
        $respuesta["alto"]    = 120;
    } else {
