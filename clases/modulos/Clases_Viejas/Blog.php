...
class Blog {
    ...
    public function __construct($id = NULL) {
        ...
        $consulta = $sql->filaEnObjeto($sql->seleccionar(array('blogs'), array('registros' => 'COUNT(id)')));
        $this->registros = $consulta->registros;
        //Saber el numero de registros activos
        $consulta = $sql->filaEnObjeto($sql->seleccionar(array('blogs'), array('registros' => 'COUNT(id)'), 'activo = "1"'));
    ...
    public function adicionar($datos) {
        ...
        $datosBlog['contenido'] = Variable::filtrarTagsInseguros($datos['contenido']);
