...
class Noticia {
    ...
    public function __construct($id = NULL) {
        ...
        $consulta = $sql->obtenerValor('noticias', 'COUNT(id)', '');
        $this->registros = $consulta;

        $consulta = $sql->obtenerValor('noticias', 'COUNT(id)', 'activo = "1"');
        $this->registrosActivos = $consulta;
     ...
     */
    public function listar($inicio = 0, $cantidad = 0, $excepcion = NULL, $condicion = NULL, $idPerfilUsuario = NULL, $idModulo, $filtroCategoria = NULL) {
...
//fin del metodo listar
     ...
     * @return arreglo             Lista de noticias
     */
    public function listarMasVisitadas($inicio = 0, $cantidad = 0, $excepcion = NULL, $condicion = NULL, $idPerfil = NULL, $idModulo, $filtroCategoria = NULL) {
        global $sql, $configuracion, $sesion_usuarioSesion;
        /*         * * Validar la fila inicial de la consulta ** */
        if (!is_int($inicio) || $inicio < 0) {
            $inicio = 0;
...
//fin del metodo Noticias que me gustan
     ...
     * @return arreglo             Lista de noticias
     */
    public function listarMasNoticiasUsuario($inicio = 0, $cantidad = 0, $excepcion = NULL, $condicion = NULL, $idPerfilUsuario = NULL, $idModulo, $filtroCategoria = NULL, $idUsuarioPropietario, $idNoticiaActual) {
        global $sql, $configuracion, $sesion_usuarioSesion;
        /*         * * Validar la fila inicial de la consulta ** */
        if (!is_int($inicio) || $inicio < 0) {
            $inicio = 0;
