...
class AYAH {
        ...
        protected $__version_number = '1.1.1';
        ...
        public function __construct($params = array())
        {
                ...
                if (file_exists('plugins/ayah_config.php')) {
                        require_once('plugins/ayah_config.php');
                } else {
                ...
                $this->ayah_publisher_key = "0f17813a1f3344702046a0e3fb4f4b821f6df254";
                $this->ayah_scoring_key = "0f17813a1f3344702046a0e3fb4f4b821f6df254";
        ...
        protected function doJSONArrayDecode($string) {
                ...
                } elseif (file_Exists("plugins/json.php")) {
